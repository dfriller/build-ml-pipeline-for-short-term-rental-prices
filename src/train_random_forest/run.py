...
def go(args):
    ...
    # there was a problem with the infer signatur function and the format of some x_val. that's why
    # i transformed them using the code: (found it in the knowledge section of this course=
